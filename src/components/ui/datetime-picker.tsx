...
const TimePickerInput = React.forwardRef<HTMLInputElement, TimePickerInputProps>(
    (
        ...
        const date = initialDate ?? new Date(new Date().setHours(0, 0, 0, 0))
...
const TimePicker = React.forwardRef<TimePickerRef, TimePickerProps>(
    ({date, onChange, hourCycle = 24, granularity = 'second', id}, ref) => {
        ...
        return (
            <div className="flex items-center justify-center gap-2" id={id}>
                <TimePickerInput
            ...
            <Popover>
                <PopoverTrigger asChild disabled={disabled}>
                    <Button
                        ...
                        variant="outline"
                        className={cn(
                            'w-full justify-start text-left font-normal disabled:opacity-50 disabled:cursor-not-allowed bg-background',
                ...
                <PopoverContent className="w-auto p-0" index={100}>
                    <Calendar
                        mode="single"
                        selected={value}
                        month={month}
